...
- (void)creatControllers
{
    ...
    // 2.投资理财
    ShopRootController * shop = [[ShopRootController alloc] init];
    BaseNavigationController * shopNav = [[BaseNavigationController alloc] initWithRootViewController:shop];
    UITabBarItem *item2 = [[UITabBarItem alloc] initWithTitle:@"洗车店"
    ...
    NSArray *controllers = [NSArray arrayWithObjects:homeNav, shopNav, meNav, aboutNav, nil];
